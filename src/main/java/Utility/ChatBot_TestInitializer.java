...
public class ChatBot_TestInitializer extends WaitsManager {

	private static final Logger logger = LogManager.getLogger(ChatBot_TestInitializer.class);
	...
	@Parameters({ "FileName" })
	public void setup(@Optional("CrChatBot.html") String nameForReport) throws Exception {
