...
public class CSAT_Contributor_TestInitializer extends WaitsManager {

	private static final Logger logger = LogManager.getLogger(CSAT_Contributor_TestInitializer.class);
